...
print(names_a)
names_b = find_names_starting_with("B", list_of_names)
print(names_b)

names_length_9 = find_names_of_length(9, list_of_names)
print("Names by length 9:")
print(names_length_9)


names_start_with_E = find_names_starting_with("E",list_of_names)
result = find_names_of_length(6,names_start_with_E)
print(result)
